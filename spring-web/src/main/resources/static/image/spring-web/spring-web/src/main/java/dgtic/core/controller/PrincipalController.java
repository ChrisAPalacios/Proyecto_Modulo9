...
public class PrincipalController {
    ...
    public String mappingClase(Model modelo){
        modelo.addAttribute("contenido","@RequestMapping en Clase");
        return "principal/requestmapping";
    }
    @GetMapping("getmapping")
    public String getMapping(Model modelo){
        modelo.addAttribute("contenido","@GetMapping en Metodo");
    ...
    public String getParametroDos(@PathVariable("edad")int edad,
